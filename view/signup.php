        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form id="logIn" method="post" action="index.php?c=login&a=signIn">
              ...
              <div>
                <h3 align="left">Comfirm Password</h3>
                <input type="password" class="form-control required" placeholder="Password" name="comfirmPassword" />
              </div>
              <div class="checkbox">
              <label><input type="checkbox" name="remember"> Remember me</label>
                <button class="btn btn-primary submit" type="submit"><i class="glyphicon glyphicon-user"></i> Creat an account</button>
              </div>
              <div class="clearfix"></div>
                <p class="change_link">continue with<br>
