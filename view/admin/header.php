        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li><a href="../index.php" class="nav-link px-2 text-white"><i class="fas fa-home" color="white"></i> Trang chủ</a></li>
                <li><a href="#" class="nav-link px-2 text-white"><i class="fas fa-comments-dollar" color="white"> Góp ý</a></li>
                <li><a href="#" class="nav-link px-2 text-white"><i class="fas fa-info" color="white"> About</a></li>
            </ul>
